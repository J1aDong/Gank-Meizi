...
public class RightDrawable extends Drawable {
    ...
    public RightDrawable(final View view) {
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                                                                 ...
                                                                 public void onGlobalLayout() {
                                                                     ...
                                                                     mPointF3.x = MyUtil.dp2px(view.getContext(), 12) * 1f;
                                                                     mPointF3.y = mWidth / 2 * 1f;
                                                                     mPointF2.x = mWidth / 2 * 1f;
                                                                     mPointF2.y = MyUtil.dp2px(view.getContext(), 12) * 1f;
                                                                     mPointF1.x = mWidth - MyUtil.dp2px(view.getContext(), 12);
                                                                     mPointF1.y = mWidth / 2;
